...
var marioAnimation, obstacleAnimation, wallAnimation, groundAnimation,backGround;
var flag;
var LOSE=0;
var PLAY=1,text;
var WIN=2;
...
function preload()
{
  marioAnimation=loadImage("images/explore.png");
  obstacleAnimation=loadAnimation("images/obstacle.png");
  wallAnimation=loadAnimation("images/wall.png");
  groundAnimation=loadAnimation("images/salb.png");  
  flagAnimation=loadAnimation("images/prize.png");
backGround=loadImage("images/jungle.png")
}
...
function draw() {
  ...
  {  
      ...
      gameState=WIN;
        ...
        if(mario.spt.isTouching(obstacleGroup)){
          gameState=LOSE;
        }
  ...
  { 
     ...
     fill ("magenta")
     textSize(30)
    text("you loose",mario.spt.x,200);
   mario.applyGravity()
   mario.spt.collide(platformGroup);
    }
